...
const SearchPitches = () => {
  ...
  return (
    <div className="relative flex max-w-[62.5rem] w-[100%] flex-row justify-center">
      <label htmlFor="search" className="sr-only">
        Search
      </label>
      <input
        className="peer block w-1/2 rounded-md border border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 text-black"
